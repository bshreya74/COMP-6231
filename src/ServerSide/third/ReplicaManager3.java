		...
		try {
			...
			while(true){
				...
				{	
					...
					if(restart_counter == 2){
						...
						if(flag_leader == true)
						{
							...
							//MTL
							broadcastLeader(RC,msg,6012);
							//LVL
							broadcastLeader(RC,msg,6022);
							//DDO
							broadcastLeader(RC,msg,6032);
							flag_leader = false;
							RM1 = true;
						}
				...
				if(request.contains("Make RM2 leader"))
				{
					...
					System.out.println("RM2 is the new leader");
					RM2 = true;
					RM1 = false;
				...
				if(request.contains("Make RM3 leader")){
					...
					//MTL
					broadcastLeader(RC,request,6012);
					//LVL
					broadcastLeader(RC,request,6022);
					//DDO
					broadcastLeader(RC,request,6032);
					flag_leader = true;
					RM1 = false;
					RM2 = false;
				}
